...
Is as simple as putting libraries=['name1','name2',...] inside the Extension module. Here we do it "m".
"""

module = Extension('Order', sources = ['Order.c'],libraries=['gsl','gslcblas','m'], include_dirs=[numpy.get_include(),'/usr/local/include']) 
setup(name = 'Order Algorithm: C/Python Extension ', version = '1.0', ext_modules = [module])
